-- ============================================================
-- UCIL DEMO SEED — FOR DEMO / STAGING ENVIRONMENTS ONLY
-- ============================================================
-- DO NOT RUN IN PRODUCTION.
-- This file seeds the system with representative data to
-- demonstrate the platform before real client data is ingested.
--
-- Production installations start with a clean database.
-- Every value in production must come from uploaded documents.
-- ============================================================

-- Only run after ucil-complete.sql schema is in place
-- and a user account has been created.

-- Frameworks (demo data \u2014 will be replaced by actual ingested documents)
